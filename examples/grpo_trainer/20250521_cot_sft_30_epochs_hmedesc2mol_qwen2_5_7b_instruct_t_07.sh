...
python3 -m verl.trainer.main_ppo \
    ...
    actor_rollout_ref.model.path=/vepfs/fs_ckps/guojianz/llm/llama_factory/qwen25-7b-in/full/sft_hme_desc2mol_cot_7b_30_epoch \
    ...
    trainer.project_name='hme_desc2mol_t_07_cot_sft_30epochs' \
    trainer.experiment_name='qwen2_7b_function_rm' \
    trainer.n_gpus_per_node=2 \
    trainer.nnodes=1 \
    trainer.save_freq=100 \
    trainer.test_freq=5 \
    trainer.total_epochs=15  2>&1 | tee hme_desc2mol_t_07_cot_sft_30epochs.log

    ## 64g * 2

    # actor_rollout_ref.rollout.n=8 \

cd /vepfs/fs_ckps/guojianz/llm/verl_exp/hme_desc2mol_t_07_cot_sft_30epochs/qwen2_7b_function_rm
