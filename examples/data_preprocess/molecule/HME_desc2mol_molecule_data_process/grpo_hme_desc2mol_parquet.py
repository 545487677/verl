...
if __name__ == "__main__":
    ...
    parser.add_argument("--train_json", type=str, default="/fs_mol/guojianz/projects/grpo/desc2mol/sft_data/hme_desc2mol_processed_train.json")
    parser.add_argument("--test_json", type=str, default="/fs_mol/guojianz/projects/grpo/desc2mol/sft_data/hme_desc2mol_processed_test.json")
    parser.add_argument("--local_dir", type=str, default="/fs_mol/guojianz/projects/grpo/desc2mol/grpo_data")
